...
<!-- Personal note: I'm using this fork primarily to learn how LLM agents handle financial data pipelines. The soul/persona framing is interesting — keeping it intact but may eventually add a section on how uncertainty should be communicated to the user. -->
